...
namespace NekoVampire.Web
{
    public class ReactiveOAuthClient
    {
        ...
        private ReactiveWebClient req;
        private Random rnd;
        #endregion

        #region
        public ReactiveOAuthClient(string consumerKey, string consumerSecret, string requestTokenURL, string accessTokenURL, string authorizeURL)
        {
            this.req = new ReactiveWebClient();
            this.rnd = new Random();
        ...
        public ReactiveOAuthClient(string consumerKey, string consumerSecret, string requestTokenURL, string accessTokenURL, string authorizeURL, string token, SecureString tokenSecret)
        ...
        public string GetRequestToken()
        {
            ...
            try
            {
                response = req.HttpRequest(requestTokenURL, "GET", default(DateTime), null, Enc, header)
                    .GetResponseText()
                    .Select(s => ParseOAuthResponce(s))
                    .Single();
            }
        ...
        public IObservable<WebResponse> HttpRequest(string url, string method, DateTime since, IDictionary<string, string> postData, Encoding enc, IDictionary<string, string> headers)
        {
            ...
            return req.HttpRequest(url, method, since, postData, Enc, head);
        }
        ...
        /// <param name="url">URL</param>
        /// <param name="method">HTTPメソッド</param>
        public IObservable<WebResponse> HttpRequest(string url, string method)
        {
            return HttpRequest(url, method, default(DateTime), null);
        }
        ...
        /// <param name="method">HTTPメソッド</param>
        /// <param name="since">IfModifiedSinceパラメータ</param>
        public IObservable<WebResponse> HttpRequest(string url, string method, DateTime since)
        {
            return HttpRequest(url, method, since, null);
        }
        ...
        /// <param name="method">HTTPメソッド</param>
        /// <param name="postData">POSTで送信するデータ</param>
        public IObservable<WebResponse> HttpRequest(string url, string method, IDictionary<string, string> postData)
        {
            return HttpRequest(url, method, default(DateTime), postData);
        }
        ...
        /// <param name="postData">POSTで送信するデータ</param>
        /// <param name="enc">文字エンコーディング</param>
        public IObservable<WebResponse> HttpRequest(string url, string method, IDictionary<string, string> postData, Encoding enc)
        {
            return HttpRequest(url, method, default(DateTime), postData, enc);
        }
        /// <summary>HTTPリクエストを行います</summary>
        /// <param name="url">URL</param>
        /// <param name="method">HTTPメソッド</param>
        /// <param name="since">IfModifiedSinceパラメータ</param>
        /// <param name="postData">POSTで送信するデータ</param>
        public IObservable<WebResponse> HttpRequest(string url, string method, DateTime since, IDictionary<string, string> postData)
        {
            return HttpRequest(url, method, since, postData, Encoding.Default);
        }
        ...
        /// <param name="postData">POSTで送信するデータ</param>
        /// <param name="enc">文字エンコーディング</param>
        public IObservable<WebResponse> HttpRequest(string url, string method, DateTime since, IDictionary<string, string> postData, Encoding enc)
        {
            return HttpRequest(url, method, since, postData, enc, null);
        }
        #endregion
